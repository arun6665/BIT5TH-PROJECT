...
<head>
    ...
    <link rel="stylesheet" href="assets/css/jm-navbar-disney.css">
    <link rel="stylesheet" href="assets/css/Modern-2-Layer-Navbar.css">
...
<br />
<br />
<p> Thanks email already exits!</p>
<p><a href="joinus.php">Try again</a><br />
<a href="index.html">Go back to home</a></p>

</center>


       <div class="footer-clean" style="height: 282px;">
    <footer style="background-image: url(&quot;assets/img/dangg.png&quot;);background-repeat: no-repeat;background-size: cover;padding:60px;height: 230px;margin: 0px; margin-bottom: 0px; bottom: 0; position: fixed; width: 1400px;">
        <div class="container">
